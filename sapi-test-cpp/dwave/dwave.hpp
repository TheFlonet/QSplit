...
const char SAPI_HOME_EU[] = "https://eu-central-1.cloud.dwavesys.com/sapi/v2/";
const char SOLVER_ACCESS[] = "solvers/remote/";
const char PROBLEM_ACCESS[] = "problems/";
const char ANSWER_ACCESS[] = "answer/";
...
struct ProblemAnswer {
    struct Answer {
        // TODO(Mario Bifulco) check, this type may be std::vector<std::vector<bool>>
        std::vector<bool> solutions;
        // TODO(Mario Bifulco) check, this type may be std::vector<double>
        double energies{};
        struct QPUTiming {
